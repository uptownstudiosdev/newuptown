...
<!--[if gt IE 9]><!--> <html class="no-js" <?php language_attributes(); ?> > <!--<![endif]-->
	<head>
		...
		<!-- <link rel="prerender" href="<?php bloginfo('url'); ?>/our-portfolio/"> -->
	...
	<body <?php body_class(); ?>>
		<div id="preloader" style="position: fixed; left: 0; top: 0; z-index: 9999999; width: 100%; height: 100%; overflow: visible; background: #FFF;"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2017/01/logo-25th-anniversary.svg" class="preloader-logo"></div>
